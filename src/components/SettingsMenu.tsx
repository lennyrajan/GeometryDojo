...
export const SettingsMenu: React.FC<SettingsMenuProps> = ({
    ...
    return (
        <div className="absolute inset-0 z-50 bg-black/60 flex items-center justify-center p-6 backdrop-blur-sm">
            <div className={`w-full max-w-md rounded-2xl p-6 shadow-2xl animate-in zoom-in-95 duration-200 bg-background border border-primary/20 text-foreground max-h-[90vh] overflow-y-auto`}>
