...
interface GameState {
    ...
    difficulty: Difficulty; // Global difficulty setting (or per player? Usually global for the session is easier, but per player preference is better. Let's keep it global for simplicity of switching, or per player. Plan said global settings. Let's keep difficulty global for the UI, but progress is stored per difficulty.)
}
