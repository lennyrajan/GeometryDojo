...
const levels: Level[] = [
    ...
    { id: 33, name: "The Hat", description: "Top it off.", fact: "The bicorne hat was a icon of early 19th century.", shape: [{ x: 0.2, y: 0.7 }, { x: 0.3, y: 0.7 }, { x: 0.5, y: 0.3 }, { x: 0.7, y: 0.7 }, { x: 0.8, y: 0.7 }, { x: 0.8, y: 0.8 }, { x: 0.2, y: 0.8 }, { x: 0.2, y: 0.7 }], unlockScore: 92.0 },
    ...
    { id: 77, name: "The Skull", description: "Memento mori.", fact: "The human skull is made of 22 different bones.", shape: createParametric((t) => 0.4 * Math.cos(t) + 0.05 * Math.cos(3 * t), (t) => 0.5 * Math.sin(t) + 0.05 * Math.sin(2 * t), 0.5, { x: 0.5, y: 0.45 }, 0, 2 * Math.PI), unlockScore: 92.0 },
